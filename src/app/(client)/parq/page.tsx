...
const PARQ_QUESTIONS: Question[] = [
  {
    ...
    subtext:
      "E.g., Heart murmur, arrhythmia, coronary artery disease, or past cardiac events.",
  },
  {
    id: "q2",
    question:
      "2. Do you feel pain or pressure in your chest when performing physical activity?",
    subtext:
      "Chest tightness, pain radiating to arms/jaw during exercise or climbing stairs.",
  },
  {
    id: "q3",
    question:
  ...
  },
  {
    id: "q5",
    question:
      "5. Do you have a bone or joint problem that could be aggravated by vigorous exercise?",
    subtext:
      "E.g., Chronic lower back herniation, knee ligament tears, hip pain.",
  },
  {
    id: "q6",
    question:
    ...
    subtext:
      "Beta-blockers, ACE inhibitors, diuretics, or anti-arrhythmic medication.",
  },
  {
    id: "q7",
    question:
    ...
    subtext:
      "Severe asthma, pregnancy complications, recent surgery, or unexplained illness.",
  },
];
...
export default function ParqScreeningPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!agreedWaiver || !clientName || !clientEmail) {
      alert(
        "Please complete the required details and accept the liability waiver.",
      );
      return;
    }
    ...
    try {
      ...
      if (!res.ok || !data.success)
        throw new Error(data.error || "Unable to save screening.");
      setResult({
      ...
      alert(
        err instanceof Error
          ? err.message
          : "Unable to save your screening. Please retry.",
      );
    } finally {
      setLoading(false);
    }
            ...
            {result.isCleared ? (
              <>
                ...
                <p className="text-xs text-gray-600 mt-2">
                  You have cleared the Physical Activity Readiness Questionnaire
                  (PAR-Q). You can now book personal training sessions on
                  Trainrr.
                </p>
              ...
              <>
                ...
                <p className="text-xs text-gray-600 mt-2">
                  Based on your health answers, we recommend consulting a
                  licensed physician (MBBS) before starting vigorous workout
                  sessions.
                </p>
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4 my-6 text-left text-xs text-amber-900 space-y-2">
                  ...
                  <div>
                    • Share clearance with your Trainrr coach before
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
      ...
      <section className="bg-gradient-to-br from-emerald-800 to-teal-900 text-white py-10 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="mt-2 text-emerald-100 text-xs sm:text-sm max-w-xl mx-auto">
            Please answer these 7 quick health questions before your first
            1-on-1 session to ensure your coach designs a safe, tailored
            program.
          </p>
        </div>
      </section>
      ...
      <main className="max-w-3xl mx-auto px-4 py-8 flex-1 w-full">
        <form
          ...
          className="bg-white rounded-3xl border border-gray-200 shadow-sm p-6 sm:p-10 space-y-8"
        >
          {/* Client Details */}
          <div>
            <h2 className="text-base font-bold text-gray-900 mb-4 flex items-center gap-2">
              <UserCheck className="w-4 h-4 text-emerald-600" /> Client
              Information
            </h2>
          ...
          <div className="border-t border-gray-100 pt-6">
            <h2 className="text-base font-bold text-gray-900 mb-2 flex items-center gap-2">
              <Activity className="w-4 h-4 text-emerald-600" /> 7-Point Health
              Readiness Checklist
            </h2>
          ...
          <div className="border-t border-gray-100 pt-6">
            <h2 className="text-base font-bold text-gray-900 mb-3 flex items-center gap-2">
              <FileText className="w-4 h-4 text-emerald-600" /> Assumption of
              Risk & Liability Release
            </h2>
            <div className="bg-gray-50 border border-gray-200 rounded-2xl p-4 text-[11px] text-gray-600 max-h-32 overflow-y-auto leading-relaxed space-y-2">
              <p>
                By enrolling in personal training sessions facilitated through
                Trainrr, I acknowledge that physical exercise involves inherent
                risks of bodily injury or fatigue. I understand that I am
                voluntarily participating in physical workouts.
              </p>
              <p>
                I confirm that the information provided in this PAR-Q is
                accurate to the best of my knowledge. I agree to notify my coach
                immediately of any changes in my physical condition or symptoms
                occurring during sessions.
              </p>
            </div>
          ...
          >
            {loading
              ? "Verifying Health Readiness..."
              : "Submit Health Screening & Digital Waiver"}
